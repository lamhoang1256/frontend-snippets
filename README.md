...
| `size-full`          | Set width and set height equal to 100%                   |
| `square`             | Set width and set height equally (square)                |
| `circle`             | Set width and set height equally, radius = 50% (circle)  |
...
| `flex-center`        | Flex align center and justify center                     |
| `facb`               | Flex align center and justify spacebetween               |
...
| `@375`               | Responsive media above smallest screen                   |
| `@768`               | Responsive media above mobile                            |
| `@1024`              | Responsive media above tablet                            |
| `@1280`              | Responsive media above small pc                          |
| `@1279`              | Responsive media below small pc                          |
...
| `tsrafce`          | [View Code](docs/reactsnippets.md#tsrafce)          |
| `tsrafce-children` | [View Code](docs/reactsnippets.md#tsrafce-children) |
| `tsrafce-styled`   | [View Code](docs/reactsnippets.md#tsrafce-styled)   |
| `tsrafc`           | [View Code](docs/reactsnippets.md#tsrafc)           |
